...
public class RMain {
	...
	public static void main(String[] args) {
		...
		try {
			System.out.println(
					regressionAnalysis.getSimpleRegressionAnalysis(Arrays.asList(161,174,151,185,182,180,178), Arrays.asList(174,178,161,185,180,182,180), 165)		
					);
			
			
			
//			161,174,178,180,182,180,185
//			174,178,161,185,180,182,180
//			161,174,151,185,182,180,178
//			151,161,174,178,180,182,185
		} catch (Exception e) {
